...
contract STARIVERPudgyPenguins10 is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public constant PRICE = uint256(1)/uint256(1**16);
    uint256 public constant MAX_BY_MINT = 20;
    uint256 public constant reveal_timestamp = 1628863896395; // Thu Jul 29 2021 20:00:00 GMT+0000
    ...
    constructor(string memory baseURI) ERC721("STARIVERPudgyPenguins10", "PPG") {
        setBaseURI(baseURI);
        pause(true);
    }
