...
> Writing deployment info to STARNFT7_rinkeby_Config.json
```
...
When the contract is deployed, the address and other information about the deployment is written to `STARNFT7_rinkeby_Config.json`. This file must be present for subsequent commands to work.
